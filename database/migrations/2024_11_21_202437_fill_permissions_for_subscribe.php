...
class FillPermissionsForSubscribe extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSubscribe constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.subscribe.create',
            'admin.subscribe.show',
            'admin.subscribe.edit',
            'admin.subscribe.delete',
            'admin.subscribe.bulk-delete',
        ]);
